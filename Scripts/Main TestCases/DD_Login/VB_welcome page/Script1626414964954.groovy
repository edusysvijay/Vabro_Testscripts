...
WebUI.setText(findTestObject('Vabro_Home_Page/input_Email address'), 'testadm21@aol.com')

WebUI.setEncryptedText(findTestObject('Vabro_Home_Page/input_Password'), 'ZaJEugbsRAzrN/6XQFXNeQ==')

WebUI.click(findTestObject('Vabro_Home_Page/img_Join_rounded_1'))

WebUI.mouseOver(findTestObject('Vabro_Home_Page/img'))

WebUI.delay(2)

WebUI.click(findTestObject('Vabro_Home_Page/img'))
