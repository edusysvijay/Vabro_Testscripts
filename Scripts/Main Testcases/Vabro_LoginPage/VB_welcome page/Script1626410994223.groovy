...
WebUI.click(findTestObject('vabro login/Page_Home Page - VABROClient/img_Join_rounded_1'))

WebUI.mouseOver(findTestObject('vabro login/Page_Home Page - VABROClient/img'))

WebUI.delay(2)

WebUI.click(findTestObject('vabro login/Page_Home Page - VABROClient/img'))
